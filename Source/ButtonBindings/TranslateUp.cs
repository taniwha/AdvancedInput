...
namespace AdvancedInput.ButtonBindings {
	...
	public class AI_BB_TranslateUp: IButtonBinding
	{
		public string name { get { return "TranslateUp"; } }
		...
		{
			if (state > 0) {
				FlightInputHandler.state.Y = 1;
			}
		}

		public AI_BB_TranslateUp (AI_FlightControl fc, ConfigNode node)
		{
		}
	}
}
