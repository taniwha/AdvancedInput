...
namespace AdvancedInput.ButtonBindings {
	...
	public class AI_BB_TranslateForward: IButtonBinding
	{
		public string name { get { return "TranslateForward"; } }
		...
		public AI_BB_TranslateForward (AI_FlightControl fc, ConfigNode node)
		{
		}
	}
}
