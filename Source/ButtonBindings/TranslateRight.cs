...
namespace AdvancedInput.ButtonBindings {
	...
	public class AI_BB_TranslateRight: IButtonBinding
	{
		public string name { get { return "TranslateRight"; } }
		...
		{
			if (state > 0) {
				FlightInputHandler.state.X = -1;
			}
		}

		public AI_BB_TranslateRight (AI_FlightControl fc, ConfigNode node)
		{
		}
	}
}
