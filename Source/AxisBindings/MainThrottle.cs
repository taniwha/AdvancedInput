...
namespace AdvancedInput.AxisBindings {
	...
	public class AI_AB_MainThrottle: IAxisBinding
	{
		public string name { get { return "MainThrottle"; } }
		...
		{
			if (updated && !flightControl.mainThrottleLock) {
				flightControl.ctrlState.mainThrottle = value;
			}
		}

		public AI_AB_MainThrottle (AI_FlightControl fc, ConfigNode node)
		{
			flightControl = fc;
			// nothing to config?
		}
