...
namespace AdvancedInput.AxisBindings {
	...
	public class AI_AB_EVARoll: IAxisBinding
	{
		public string name { get { return "EVARoll"; } }
		public ControlTypes lockMask { get { return ControlTypes.ROLL; } }
		public bool locked { get; set; }

		public void Update (float value, bool updated)
		{
			AI_FlightControl.instance.kerbalState.rotation.z = value;
		}
		...
		public AI_AB_EVARoll (ConfigNode node)
		{
		}
	}
}
