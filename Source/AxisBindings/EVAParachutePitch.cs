...
namespace AdvancedInput.AxisBindings {
	...
	public class AI_AB_EVAParachutePitch: IAxisBinding
	{
		public string name { get { return "EVAParachutePitch"; } }
		public ControlTypes lockMask { get { return ControlTypes.None; } }
		public bool locked { get; set; }

		public void Update (float value, bool updated)
		{
			AI_FlightControl.instance.kerbalState.parachute.x = -value;
		}
		...
		public AI_AB_EVAParachutePitch (ConfigNode node)
		{
		}
	}
}
