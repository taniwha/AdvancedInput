...
namespace AdvancedInput.AxisBindings {
	...
	public class AI_AB_WheelSteer: IAxisBinding
	{
		public string name { get { return "WheelSteer"; } }
		...
		{
			flightControl.ctrlState.wheelSteer = value;
		}

		public AI_AB_WheelSteer (AI_FlightControl fc, ConfigNode node)
		{
			flightControl = fc;
			// nothing to config?
		}
