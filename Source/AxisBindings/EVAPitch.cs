...
namespace AdvancedInput.AxisBindings {
	...
	public class AI_AB_EVAPitch: IAxisBinding
	{
		public string name { get { return "EVAPitch"; } }
		public ControlTypes lockMask { get { return ControlTypes.None; } }
		public bool locked { get; set; }

		public void Update (float value, bool updated)
		{
			AI_FlightControl.instance.kerbalState.rotation.x = value;
		}
		...
		public AI_AB_EVAPitch (ConfigNode node)
		{
		}
	}
}
